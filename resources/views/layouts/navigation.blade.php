<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center"> <!-- Aggiunto "items-center" per allineare verticalmente gli elementi -->
            <div class="flex items-center space-x-8"> <!-- Aggiunto "items-center" per allineare verticalmente gli elementi -->
                <!-- Logo -->
                <div class="shrink-0">
                        ...
                        <div class="flex align-middle">
                            <button class="inline-flex items-center px-3 py-[-25px] border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                                <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                                    ...
                                    <img class="w-10 h-10 rounded-full" src="{{ ('storage/' .  Auth::user()->image) }}" alt="{{ Auth::user()->id }}">
                                </button>
                            </button>
                        </div>
                    </x-slot>
